                ...
                <div class="table table-container mt-5">
                    <table class="table-bordered table-striped ">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>654654684-4</td>
                                <td><span class="asignment">BryanVasquez@gmail.com</span></td>
                                <td>654654684-4</td>
                                <td>654654684-4</td>
                                <td><span class="asignment">March 6, 2001</span></td>
                                <td class="d-flex">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="" method="">
                                        ...
                                        <label for="">Nombre Completo</label>
                                        <input type="text" name="nombre" class="form-control" placeholder="Ingresa el nombre del maestro..." disabled>
                    ...
                    <div class="modal fade" id="deleteTeacher" tabindex="-1" aria-labelledby="deleteTeacher" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="deleteTeacher">Agregar maestro</h1>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
